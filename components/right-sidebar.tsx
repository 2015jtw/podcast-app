...
const RightSidebar = () => {
  ...
  const filteredPodcasters = topPodcasters?.filter(
    ...
    >
      ...
      <section>
        ...
        {filteredPodcasters && filteredPodcasters.length > 0 ? (
          <Carousel fansLikeDetail={filteredPodcasters} />
        ) : (
          <p>No podcasters available.</p>
        )}
      </section>
      <section className="flex flex-col gap-8 pt-12">
        ...
        <div className="flex flex-col gap-6">
          {topPodcasters && topPodcasters.length > 0 ? (
            ...
            <p className="text-white-1">No top podcasters available.</p>
          )}
        </div>
      </section>
    </section>
